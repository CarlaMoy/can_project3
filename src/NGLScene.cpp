...
//  prim->createTorus("torus",0.15f,0.4f,40,40);
  ...
  shader->loadShader(PlaneProgram,
                     "shaders/GroundVert.glsl",
                     "shaders/GroundFrag.glsl");
  shader->use(PlaneProgram);

  ///create a ground plane
//  ngl::Transformation::setPosition(0.0, -1.0, 0.0);
  ngl::VAOPrimitives::instance()->createTrianglePlane("ground",100,100,10,10,ngl::Vec3::up());
