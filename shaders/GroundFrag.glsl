...
// A sampler storing our texture - note this uniform is defined by the Obj parser
...
void main() {
    ...
    FragColor = vec4(lightColor, 1.0); // * texture(tex, FragmentTexCoord);
